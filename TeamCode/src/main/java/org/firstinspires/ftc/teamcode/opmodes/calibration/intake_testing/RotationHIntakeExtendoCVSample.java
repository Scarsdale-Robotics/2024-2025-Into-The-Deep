...
@Config
@Autonomous(name="Pick Up Sample Using Horizontal Intake, Extendo, and Drivebase Rotation", group = "Calibration")
public class RotationHIntakeExtendoCVSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            double extendoPosition = linearSlides.getExtendoPosition();
            initSynchronizer(closestSample, botPose, extendoPosition);
