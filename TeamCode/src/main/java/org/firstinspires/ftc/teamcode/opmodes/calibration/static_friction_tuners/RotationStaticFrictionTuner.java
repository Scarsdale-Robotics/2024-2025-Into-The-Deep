...
@Config
@TeleOp(name="Rotation Static Friction Tuner", group="Calibration")
public class RotationStaticFrictionTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            drive.turnVelocity = kS;
            drive.driveTheta = 0;
            drive.driveSpeed = 0;
            drive.driveFieldCentric(0);
        }
